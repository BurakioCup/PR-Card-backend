...
SET CHARSET UTF8;
DROP SCHEMA IF EXISTS `qr_card`;
CREATE SCHEMA IF NOT EXISTS `qr_card` DEFAULT CHARACTER SET utf8;
USE `qr_card`;
...
---- create ----
CREATE TABLE IF NOT EXISTS `qr_card`.`users` (
...
CREATE TABLE IF NOT EXISTS `qr_card`.`cards` (
...
CREATE TABLE IF NOT EXISTS `qr_card`.`card_matrixs` (
...
CREATE TABLE IF NOT EXISTS `qr_card`.`card_my_word` (
`id` VARCHAR(64) NOT NULL COMMENT '識別ID',
`card_id` VARCHAR(32) NOT NULL COMMENT 'カード識別ID',
...
CREATE TABLE IF NOT EXISTS `qr_card`.`owned_cards` (
`id` VARCHAR(64) NOT NULL COMMENT '識別ID',
