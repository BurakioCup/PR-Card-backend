...
`name_image` VARCHAR(256) COMMENT '名前画像のパス',
`tag_image` VARCHAR(256) COMMENT 'タグ画像のパス',
`face_image` VARCHAR(256) COMMENT '顔画像のパス',
`status_image` VARCHAR(256) COMMENT 'ステータス画像のパス',
`free_image` VARCHAR(256) COMMENT '自由記述欄の画像パス',
PRIMARY KEY (`id`),
INDEX idx_auth_token (`id` ASC)
)
ENGINE = InnoDB
...
INSERT INTO `owned_cards` VALUES ("2","a","c");
INSERT INTO `owned_cards` VALUES ("3","a","d");
INSERT INTO `owned_cards` VALUES ("4","a","e");
INSERT INTO `owned_cards` VALUES ("5","a","f");
INSERT INTO `owned_cards` VALUES ("6","b","a");
INSERT INTO `owned_cards` VALUES ("7","b","c");
INSERT INTO `owned_cards` VALUES ("8","b","d");
INSERT INTO `owned_cards` VALUES ("9","b","e");
INSERT INTO `owned_cards` VALUES ("10","b","f");
INSERT INTO `owned_cards` VALUES ("11","a","g");
